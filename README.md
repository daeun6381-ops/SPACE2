            ...
            <div id="tab-home" class="tab-content space-y-12">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    ...
                    <div class="bg-white rounded-[2.5rem] p-7 shadow-xl shadow-gray-200/50 border border-gray-50 space-y-5 h-full">
                        ...
                        <button onclick="uploadPost()" id="upload-btn" class="w-full bg-pink-500 text-white py-5 rounded-2xl font-bold text-lg btn-active transition-all">
                            기억 업로드
                        </button>
                    </div>
    ...
    <script type="module">
        ...
        window.handleFileSelect = (event) => {
            ...
            if (file.size > 1024 * 1024) {
                alert("파일이 너무 커요! 1MB 이하의 사진을 선택해주세요.");
                event.target.value = "";
                return;
            }
        ...
        function applyTheme(theme) {
            ...
            if (uploadBtn) uploadBtn.className = `w-full ${t.btn} text-white py-5 rounded-2xl font-bold text-lg btn-active transition-all`;
